...
export default function Toast({ mensagem, tipo = "sucesso", onFechar }) {
  ...
  // de 4 segundos. Sempre que "mensagem" mudar, o efeito roda de novo
  // (reiniciando o tempo), e a função de "limpeza" (o return) cancela o
  // temporizador anterior, evitando temporizadores duplicados rodando ao mesmo tempo.
  useEffect(() => {
